...
| renderOrder 层序 | manifest layers 按 renderOrder 升序（`kind: official-scene`） | 已落地（含黑色底衬层陷阱，见 `docs/官网Spine动画抓取流程.md`） |
...
- 相关文档：`docs/官网Spine动画抓取流程.md`、`docs/adr/0009-官网spine动画增量接入.md`
